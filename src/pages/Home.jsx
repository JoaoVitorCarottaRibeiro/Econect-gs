        ...
        <>
            <section className="relative bg-custom-image bg-cover bg-center h-screen flex items-center">
                ...
                <div className="relative text-center mx-auto p-4 z-10">
                    ...
                    <h2 className="text-white text-xl md:text-2xl mt-4">{subtitulo}</h2>
                </div>
            </section>
            <section className="bg-green-50  py-20">
                <h1 className="text-center font-bold text-2xl md:text-3xl pb-7 text-[#44D764]">Nossas Missões</h1>
                <ContainerHome
